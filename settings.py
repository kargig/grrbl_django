# Django settings for grrbl_django project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    # ('George K', 'kargig@gmail.com'),
)
...
SECRET_KEY = 'cl7(heptl_&71pi622wn@bw@(@&i^n*28ncv)ai&fzf@#v7hgv'
...
ROOT_URLCONF = 'grrbl_django.urls'
